...
class CreditCard
 ...
 # @cc_number.gsub!(/[ -]/, "")
    # visa = @cc_number.scan(/^4[0-9]{12}(?:[0-9]{3})/)
    # mastercard = @cc_number.scan()
    
    # discover = @cc_number.scan(/^6(?:011|5[0-9]{2})[0-9]{12}/)
    ...
    # discover.length == 1 ? @card_type = "Discover" : false
